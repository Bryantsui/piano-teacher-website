...
4. Fill in:
   ...
   - Country: `Hong Kong`
   - Container Name: `taikoomusic.com`
   - Target Platform: **Web**
...
9. Enter: `taikoomusic.com` → click **Scan**
...
```
Final URL:     https://www.taikoomusic.com
...
```
Final URL:     https://www.taikoomusic.com/zh
...
2. Sign in with **bryantsui2016@gmail.com**
3. Click **Add property** → **URL prefix** → enter: `https://www.taikoomusic.com`
...
5. Go to Dynadot → DNS Settings for taikoomusic.com
   - Add a **TXT** record with that value
6. Back in Search Console → click **Verify**
7. Go to **Sitemaps** → enter: `https://www.taikoomusic.com/sitemap.xml` → **Submit**
...
9. Enter website: `taikoomusic.com`
