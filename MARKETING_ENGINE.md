...
- [ ] Set up **Google Search Console** at https://search.google.com/search-console
  - Verify taikoomusic.com
  - Submit sitemap: `https://www.taikoomusic.com/sitemap.xml`
...
```
A    taikoomusic.com      →  76.76.21.21
A    www.taikoomusic.com  →  76.76.21.21
```
